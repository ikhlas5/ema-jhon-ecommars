...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Brand name of Adidas</span>
			</Link>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
                    ...
                    href="https://www.facebook.com/bay.ron.5030/" title="Facebook" className="flex items-center p-1">
					...
					<a target={'_blank'} rel="noopener noreferrer" href="https://www.instagram.com/mahmudulikhlas/" title="Instagram" className="flex items-center p-1">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Company Co. All rights reserved. Developed By Ikhlas</div>
</footer>
        </div>
    );
};
